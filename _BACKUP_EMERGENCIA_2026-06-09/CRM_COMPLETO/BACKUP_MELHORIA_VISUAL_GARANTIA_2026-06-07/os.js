...
async function saveOS() {
    ...
    const os = {
        id: osId, category: currentCategory, clientName: nome, phone: telefone, brand: marca, model: modelo, imei, defect: defeito, valor, valorCartao, technician: tecnico, observations: obs, technicalObservation: "",
...
async function saveOSEdit() {
    ...
    try {
        const updates = { clientName: n, phone: p, brand, model: m, imei, defect, technician: tecnico, valor, valorCartao, prazoGarantia, garantiaId: garantiaId || null, password, observations, updatedAt: new Date().toISOString() };
 ...
 * Prioridade Máxima: MAU USO, NÃO COBRE, 72 HORAS, R$ 80,00
 * Prioridade Secundária: QUEDA, QUEDAS, IMPACTO, IMPACTOS,
...
function highlightWarrantyTerms(text) {
    ...
    return text.replace(regex, '<span style="background:#FFD700;color:#000;font-weight:700;padding:0 2px;border-radius:2px;">$1</span>');
}
