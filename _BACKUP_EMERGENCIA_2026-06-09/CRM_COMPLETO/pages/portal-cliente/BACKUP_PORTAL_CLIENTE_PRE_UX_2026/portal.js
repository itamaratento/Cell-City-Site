...
window.Portal = {
  ...
  _handleRoute() {
    try {
      ...
      // Mostra header, home-bar, footer e WhatsApp
      const header = document.getElementById('app-header');
      const homeBar = document.getElementById('header-home-bar');
  ...
  renderLogin() {
    ...
    el.innerHTML = `
      <div class="login-container">
        <!-- Header full-width com HOME + Logo -->
        <div class="login-header">
          <img src="../../assets/logo.png" alt="Cell City"
