...
# a UI de menu (cabeçalho, status, pausa) e o log, pra nenhum módulo duplicar
# essa lógica (ver scripts/control-center/README.md, "Padrão de
# desenvolvimento" e "Padrão de logs").
#
...
# que implementar a funcionalidade real daquele módulo.
_cc_placeholder() {
  local nome="$1"
  _cc_header "$nome"
  echo ""
  echo "🚧 Módulo em construção."
  echo "   Estrutura preparada na Fase 1 — funcionalidade chega nas próximas"
  echo "   fases do roadmap (ver scripts/control-center/README.md)."
