#!/bin/bash
# Cell City Control Center — módulo Backup e Recuperação.
...
# ser chamado direto (scripts/control-center/modules/backup-recuperacao/menu.sh),
...
_cc_placeholder "Backup e Recuperação"
