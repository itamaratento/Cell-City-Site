#!/bin/bash
# Cell City Control Center — módulo Desenvolvimento.
...
# ser chamado direto (scripts/control-center/modules/desenvolvimento/menu.sh),
...
_cc_placeholder "Desenvolvimento"
