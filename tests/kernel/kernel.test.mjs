...
import * as tenantProviderMock from './mocks/tenant-provider-mock.js';
import * as tenantContextMock from './mocks/tenant-context-mock.js';
...
async function freshKernel() {
  ...
  tenantProviderMock.__reset();
  tenantContextMock.__reset();
