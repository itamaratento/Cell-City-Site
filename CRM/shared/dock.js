...
function buildDockHTML() {
  ...
  return `
    ...
    <a href="https://keep.google.com" class="dock-item" target="_blank" data-tooltip="Keep">
      <span class="dock-icon">📝</span>
    </a>
    <a href="https://calendar.google.com" class="dock-item" target="_blank" data-tooltip="Agenda">
      <span class="dock-icon">📅</span>
    </a>
    <a href="https://chat.openai.com" class="dock-item" target="_blank" data-tooltip="ChatGPT">
      <span class="dock-icon">🤖</span>
    </a>
