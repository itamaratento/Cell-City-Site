...
// ✅ NOVO: Exposição global do Banco de Fotos + Pattern Lock
...
// =====================================================================
// ✅ BANCO DE FOTOS EXTERNO (GOOGLE DRIVE) — CONFIGURAÇÃO CENTRALIZADA
// =====================================================================
// 🔧 SUBSTITUA O ID ABAIXO pelo ID da pasta da Cell City no Google Drive
// Exemplo: se a URL for https://drive.google.com/drive/folders/1ABC_xyz_789
// então DRIVE_FOLDER_ID = '1ABC_xyz_789'
const DRIVE_FOLDER_ID = ''; // ← COLE O ID DA PASTA AQUI (ou deixe vazio para abrir Drive genérico)
...
// Abre o Google Drive — no Android tenta abrir o APP direto, senão navegador
function openPhotoBank() {
    const platform = getPlatform();
    
    if (platform === 'android') {
        // Intent URL — abre o app Google Drive direto na pasta (se instalado)
        // Se não tiver o app, cai no fallback do navegador
        ...
        // iOS (Universal Link) e Desktop — HTTPS normal
        // No iOS, se o app estiver instalado, o sistema abre o app automaticamente
...
// ✅ Listener na logo (redundância de segurança para voltar ao dashboard)
