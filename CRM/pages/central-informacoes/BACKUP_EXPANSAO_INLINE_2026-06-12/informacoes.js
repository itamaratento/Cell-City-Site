...
function abrirTelaCheiaInfo(id, event) {
    ...
    infoLeituraScroll = { x: window.scrollX, y: window.scrollY };
    ...
    document.documentElement.classList.add('info-leitura-lock');
...
function fecharTelaCheiaInfo() {
    ...
    document.documentElement.classList.remove('info-leitura-lock');
    document.body.classList.remove('info-leitura-lock');
    requestAnimationFrame(() => window.scrollTo(infoLeituraScroll.x, infoLeituraScroll.y));
}
